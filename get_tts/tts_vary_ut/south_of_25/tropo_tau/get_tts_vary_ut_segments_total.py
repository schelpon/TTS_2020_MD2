...
path = "/UTLS/schelpon/TTS_2020/get_tts/tts_vary_ut/south_of_25/data_prep/contrast_ratios_ut_seg_twp.pkl"
...
segment_info.to_pickle('./segment_info_campavgbl_tropotau_twp.pkl')

# save others 
utbl_allseg.to_pickle('./utbl_allseg_campavgbl_tropotau_twp.pkl')
mustar_allseg.to_pickle('./mustar_allseg_campavgbl_tropotau_twp.pkl')
tau_allseg.to_pickle('./tau_allseg_campavgbl_tropotau_twp.pkl')
gf_allseg.to_pickle('./gf_allseg_campavgbl_tropotau_twp.pkl')
t_allseg.to_pickle('./t_allseg_campavgbl_tropotau_twp.pkl')
