...
segment_info.to_pickle('./segment_info_campavgbl_bltau_twp.pkl')

# save others 
utbl_allseg.to_pickle('./utbl_allseg_campavgbl_bltau_twp.pkl')
mustar_allseg.to_pickle('./mustar_allseg_campavgbl_bltau_twp.pkl')
tau_allseg.to_pickle('./tau_allseg_campavgbl_bltau_twp.pkl')
gf_allseg.to_pickle('./gf_allseg_campavgbl_bltau_twp.pkl')
t_allseg.to_pickle('./t_allseg_campavgbl_bltau_twp.pkl')
