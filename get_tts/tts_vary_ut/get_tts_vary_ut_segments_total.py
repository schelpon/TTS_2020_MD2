...
path = "./data_prep/contrast_ratios_ut_seg.pkl"
...
segment_info.to_pickle('./segment_info_campavgbl.pkl')

# save others 
utbl_allseg.to_pickle('./utbl_allseg_campavgbl.pkl')
mustar_allseg.to_pickle('./mustar_allseg_campavgbl.pkl')
tau_allseg.to_pickle('./tau_allseg_campavgbl.pkl')
gf_allseg.to_pickle('./gf_allseg_campavgbl.pkl')
t_allseg.to_pickle('./t_allseg_campavgbl.pkl')
