...
############ --------------- LOAD SEGMENT DATA --------------- ###########
utbl_allseg = pd.read_pickle('./utbl_allseg_sameflightbl.pkl')
mustar_allseg = pd.read_pickle('./mustar_allseg_sameflightbl.pkl')
tau_allseg = pd.read_pickle('./tau_allseg_sameflightbl.pkl')
t_allseg = pd.read_pickle('./t_allseg_sameflightbl.pkl')
gf_allseg = pd.read_pickle('./gf_allseg_sameflightbl.pkl')
seg_info = pd.read_pickle('./segment_info_sameflightbl.pkl')
...
# --------------- save figure 
ax0.text(10e-1, 1.1, 'Same flight BL', fontsize = 10)
svpath = '/UTLS/schelpon/TTS_2020/get_tts/figures/'
fig.savefig(svpath + 'tts_vary_ut_sameflightbl.png')  
...
ax.set_title('c) Distribution of Mean and Modal Transit Times - same flight BL', fontsize = 20)
ax.set_xlabel("Transit Time [days]" ,fontsize=15)
ax.tick_params(labelsize=15)

# --------------- save figure 
svpath = '/UTLS/schelpon/TTS_2020/get_tts/figures/'
fig.savefig(svpath + 'boxplot_vary_ut_sameflightbl.png')  
...
g.fig.suptitle('b) Distrubution of Mean Transit Times - same flight BL',  fontsize = 30)
...
plt.text(5, 40, 'Campaign Average', color = myblue, fontsize = 26)
plt.text(5, 38, 'Segment Average', color = myred, fontsize = 26)
...
# --------------- save figure 
svpath = '/UTLS/schelpon/TTS_2020/get_tts/figures/'
g.savefig(svpath + 'boxplot_vary_ut_means_sameflightbl.png')  
...
h.fig.suptitle('b) Distrubution of Modal Transit Times - same flight BL',  fontsize = 30)
...
plt.text(5, 10.5, 'Campaign Average', color = myblue, fontsize = 26)
plt.text(5, 10, 'Segment Average', color = myred, fontsize = 26)
...
# --------------- save figure 
svpath = '/UTLS/schelpon/TTS_2020/get_tts/figures/'
h.savefig(svpath + 'boxplot_vary_ut_modes_sameflightbl.png')  
